      ...
      <div className='flex items-center justify-center bg-cover bg-[url("/ai-bg.jpg")] w-full'>
        <div className='lg:w-4/5 font-mono min-h-screen text-white'>
          <div className='px-5 sm:px-14 md:pl-14 md:pr-36'>
            <div className=''>
              <h2 className='md:pl-20 text-[#d8dbdb] text-3xl sm:text-4xl pt-10 hover:motion-preset-typewriter hover:motion-duration-1500 font-bold'>Getting Started With Face Recognition</h2>
...
export default FRDocumentation;