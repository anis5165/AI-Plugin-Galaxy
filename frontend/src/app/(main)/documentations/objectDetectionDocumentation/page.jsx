            ...
            <div className='pt-10'>
              ...
              <div className='text-[#d8dbdb] pt-10'>
                ...
                <div className='pl-8 md:pl-28 pb-20'>
                  <div className='text-[#94A3B8]'>Thank you for using AI Extensio! We hope this documentation helps you integrate our AI components easily. For any further assistance, feel free to contact us <Link href="/contactus">here</Link>.
                  </div>
                </div>
              </div>
            </div>
...
export default ODDocumentation;